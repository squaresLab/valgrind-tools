...
DIST_COMMON = $(top_srcdir)/Makefile.all.am $(srcdir)/Makefile.in \
	$(srcdir)/Makefile.am $(top_srcdir)/configure \
	$(am__configure_deps) $(srcdir)/config.h.in \
	$(srcdir)/valgrind.spec.in $(srcdir)/valgrind.pc.in \
	$(srcdir)/glibc-2.X.supp.in \
	$(top_srcdir)/drd/scripts/download-and-build-splash2.in \
	$(dist_noinst_SCRIPTS) $(dist_noinst_DATA) \
	$(pkginclude_HEADERS) AUTHORS COPYING NEWS README compile \
...
ACLOCAL = ${SHELL} /home/dskatz/valgrind/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/dskatz/valgrind/missing autoconf
AUTOHEADER = ${SHELL} /home/dskatz/valgrind/missing autoheader
AUTOMAKE = ${SHELL} /home/dskatz/valgrind/missing automake-1.14
AWK = gawk
BOOST_CFLAGS = 
BOOST_LIBS = 
CC = gcc
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /home/dskatz/valgrind/missing makeinfo
MKDIR_P = /bin/mkdir -p
...
PACKAGE_STRING = Valgrind 3.14.0.SVN
PACKAGE_TARNAME = valgrind
PACKAGE_URL = 
PACKAGE_VERSION = 3.14.0.SVN
PATH_SEPARATOR = :
PERL = /usr/bin/perl
...
VG_TMPDIR = /tmp
abs_builddir = /home/dskatz/valgrind
abs_srcdir = /home/dskatz/valgrind
abs_top_builddir = /home/dskatz/valgrind
abs_top_srcdir = /home/dskatz/valgrind
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/dskatz/valgrind/install-sh
...
pdfdir = ${docdir}
prefix = /home/dskatz/valgrind-bin
